        ...
        <li class="list-group-item">
            ...
            <form action="" method="GET">
                <div class="form-floating">
                    <select class="form-select t-s" id="floatingSelect" name="station" aria-label="Floating label select example" onchange="this.form.submit()">
                        <option selected><?= $data['metar']['station']; ?></option>
